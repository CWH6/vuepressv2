import{_ as i,r as s,o as d,c as r,a as e,b as n,d as c,e as l}from"./app-_OZj9BKu.js";const t={},o=e("h2",{id:"vue-简单部署",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#vue-简单部署","aria-hidden":"true"},"#"),n(" Vue 简单部署")],-1),u=e("h3",{id:"_1、创建dockerfile",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#_1、创建dockerfile","aria-hidden":"true"},"#"),n(" 1、创建Dockerfile")],-1),p={href:"https://gitee.com/daidaibg/IofTV-Screen#https://gitee.com/link?target=https%3A%2F%2Fwww.daidaibg.com%2Fbigscreen",target:"_blank",rel:"noopener noreferrer"},v=l(`<p>在 Vue 项目的根目录下创建名为 Dockerfile 的文件，并没有后缀。文件内容如下</p><div class="language-vue line-numbers-mode" data-ext="vue"><pre class="language-vue"><code># 使用 Node 14 镜像作为基础镜像
FROM node:14
